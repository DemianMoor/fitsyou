...
export function LegalPage({
  ...
  return (
    <div style={{ paddingTop: 64 }}>
      ...
      {/* Draft banner — remove once counsel finalizes. */}
      ...
      <section style={{ background: BONE, padding: "64px 32px 112px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          <p style={{ fontFamily: "var(--font-archivo), sans-serif", fontSize: 16, color: OBSIDIAN, lineHeight: 1.8, margin: "0 0 40px" }}>{intro}</p>
          {sections.map((s) => (
