            ...
            {PROTOCOLS.map((p, i) => (
              <div key={p.name} style={{ background: i % 2 === 0 ? OBSIDIAN : PINE, padding: "52px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 24 }}>
                  <div>
                    <span style={{ fontFamily: "var(--font-archivo), sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: BRASS }}>{p.tag}</span>
                ...
                <p style={{ fontFamily: "var(--font-archivo), sans-serif", fontSize: 14, color: "rgba(245,242,235,0.6)", lineHeight: 1.75, margin: "0 0 28px" }}>{p.desc}</p>
