    ...
    <div style={{ paddingTop: 64 }}>
      ...
      <section style={{ background: OBSIDIAN, padding: "96px 32px 80px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
          <div>
            <span style={{ fontFamily: "Archivo, sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.22em", textTransform: "uppercase", color: BRASS }}>About</span>
            <h1 style={{ fontFamily: "Fraunces, serif", fontSize: "clamp(44px, 5.5vw, 80px)", fontWeight: 400, color: BONE, letterSpacing: "-0.03em", margin: "16px 0 24px", lineHeight: 0.97 }}>
              We got tired of<br /><em style={{ fontStyle: "italic", color: BRASS }}>generic.</em>
            </h1>
            <p style={{ fontFamily: "Archivo, sans-serif", fontSize: 16, color: "rgba(245,242,235,0.62)", lineHeight: 1.78, margin: 0, maxWidth: 460 }}>
      ...
      <section style={{ background: BONE, padding: "128px 32px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 2fr", gap: 96, alignItems: "start" }}>
          <div>
            <span style={{ fontFamily: "Archivo, sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: BRASS }}>Mission</span>
            <div style={{ width: 32, height: 1, background: "rgba(183,146,86,0.4)", marginTop: 12 }} />
          </div>
          <div>
            <p style={{ fontFamily: "Fraunces, serif", fontSize: "clamp(24px, 3vw, 38px)", fontWeight: 400, color: OBSIDIAN, lineHeight: 1.35, letterSpacing: "-0.015em", margin: "0 0 32px" }}>
            ...
            <p style={{ fontFamily: "Archivo, sans-serif", fontSize: 15, color: ASH, lineHeight: 1.78, maxWidth: 560 }}>
      ...
      <section style={{ background: PINE, padding: "96px 32px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <span style={{ fontFamily: "Archivo, sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: BRASS }}>How we operate</span>
          <h2 style={{ fontFamily: "Fraunces, serif", fontSize: 44, fontWeight: 400, color: BONE, letterSpacing: "-0.025em", margin: "14px 0 56px", lineHeight: 1.05 }}>Four commitments.</h2>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2 }}>
            {[
              ...
              <div key={v.n} style={{ background: i % 2 === 0 ? "rgba(245,242,235,0.05)" : "rgba(245,242,235,0.03)", padding: "48px", border: "1px solid rgba(183,146,86,0.1)" }}>
                <span style={{ fontFamily: "Fraunces, serif", fontSize: 52, fontWeight: 300, color: BRASS, opacity: 0.28, lineHeight: 1, display: "block", marginBottom: 16 }}>{v.n}</span>
                <h3 style={{ fontFamily: "Archivo, sans-serif", fontSize: 14, fontWeight: 700, color: BONE, margin: "0 0 12px", letterSpacing: "0.03em" }}>{v.label}</h3>
                <p style={{ fontFamily: "Archivo, sans-serif", fontSize: 14, color: "rgba(245,242,235,0.6)", lineHeight: 1.72, margin: 0 }}>{v.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ background: BONE, padding: "128px 32px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <span style={{ fontFamily: "Archivo, sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: BRASS }}>The team</span>
          <h2 style={{ fontFamily: "Fraunces, serif", fontSize: 44, fontWeight: 400, color: OBSIDIAN, letterSpacing: "-0.025em", margin: "14px 0 56px", lineHeight: 1.05 }}>
              ...
              <div key={member.name} style={{ background: i % 2 === 0 ? OBSIDIAN : "#1A1E22", padding: "48px" }}>
                <div style={{ marginBottom: 20 }}>
                  <div style={{ width: 48, height: 48, borderRadius: "50%", background: "rgba(183,146,86,0.15)", border: "1px solid rgba(183,146,86,0.3)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 16 }}>
                    <span style={{ fontFamily: "Fraunces, serif", fontSize: 18, fontWeight: 400, color: BRASS }}>
                      {member.name.split(" ").map(n => n[0]).join("")}
                    </span>
                  </div>
                  <h3 style={{ fontFamily: "Fraunces, serif", fontSize: 22, fontWeight: 400, color: BONE, margin: "0 0 4px" }}>{member.name}</h3>
                  <span style={{ fontFamily: "Archivo, sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: BRASS }}>{member.role}</span>
                </div>
                <p style={{ fontFamily: "Archivo, sans-serif", fontSize: 14, color: "rgba(245,242,235,0.6)", lineHeight: 1.75, margin: 0 }}>{member.bio}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ background: EMBER, padding: "96px 32px" }}>
        <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
          <h2 style={{ fontFamily: "Fraunces, serif", fontSize: 48, fontWeight: 400, color: BONE, letterSpacing: "-0.025em", margin: "0 0 18px" }}>Ready to start?</h2>
          <p style={{ fontFamily: "Archivo, sans-serif", fontSize: 15, color: "rgba(245,242,235,0.8)", lineHeight: 1.72, margin: "0 0 36px" }}>Ten minutes to a plan that's actually yours.</p>
