    ...
    <div style={{ background: BONE }}>
      ...
      <section style={{ background: OBSIDIAN, minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", position: "relative", overflow: "hidden", paddingTop: 64 }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "80px 32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center", width: "100%", opacity: vis ? 1 : 0, transform: vis ? "none" : "translateY(28px)", transition: "opacity 0.85s ease, transform 0.85s ease" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
            <div>
              <span style={{ fontFamily: "Archivo, sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.24em", textTransform: "uppercase", color: BRASS }}>Measured. Made for one.</span>
              <div style={{ width: 40, height: 1, background: "rgba(183,146,86,0.35)", marginTop: 10 }} />
            </div>

            <FitMark size={28} padded={false}>
              <h1 style={{ fontFamily: "Fraunces, serif", fontSize: "clamp(52px, 6.5vw, 96px)", fontWeight: 400, color: BONE, lineHeight: 0.97, letterSpacing: "-0.03em", margin: 0, padding: "20px 24px" }}>
                Built to<br /><em style={{ fontStyle: "italic", color: BRASS }}>fit you.</em>
              </h1>
            </FitMark>

            <p style={{ fontFamily: "Archivo, sans-serif", fontSize: 17, color: "rgba(245,242,235,0.6)", lineHeight: 1.75, maxWidth: 420, margin: 0, opacity: vis ? 1 : 0, transition: "opacity 0.8s ease 0.35s" }}>
            ...
            <FitMark size={32} padded={false}>
              <div style={{ aspectRatio: "4/5", overflow: "hidden", borderRadius: 8, position: "relative", padding: 14 }}>
                ...
                <div style={{ position: "absolute", bottom: 26, left: 26, background: "rgba(16,17,20,0.82)", padding: "10px 16px", borderRadius: 2, borderLeft: `2px solid ${BRASS}` }}>
                  <span style={{ fontFamily: "Archivo, sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: BRASS }}>Placeholder — real photography coming</span>
                </div>
              </div>
            </FitMark>
          </div>
        ...
        <div style={{ position: "absolute", bottom: 28, left: "50%", transform: "translateX(-50%)", display: "flex", flexDirection: "column", alignItems: "center", gap: 5, opacity: vis ? 0.45 : 0, transition: "opacity 1s ease 1.2s" }}>
          <span style={{ fontFamily: "Archivo, sans-serif", fontSize: 9, letterSpacing: "0.2em", textTransform: "uppercase", color: BRASS }}>Scroll</span>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "22px 32px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 24, flexWrap: "wrap" }}>
          {["Delivered across all 50 states","Calibrated to your biology, not a template","No lock-in — pause or cancel anytime","Registered dietitians on staff"].map(t => (
            <div key={t} style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <FitMark size={10} />
              <span style={{ fontFamily: "Archivo, sans-serif", fontSize: 12, fontWeight: 500, letterSpacing: "0.04em", color: "rgba(245,242,235,0.72)" }}>{t}</span>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{ background: BONE, padding: "128px 32px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 96, alignItems: "center" }}>
          <div>
            <span style={{ fontFamily: "Archivo, sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: BRASS }}>The concept</span>
            <h2 style={{ fontFamily: "Fraunces, serif", fontSize: "clamp(36px, 4vw, 56px)", fontWeight: 400, color: OBSIDIAN, letterSpacing: "-0.025em", lineHeight: 1.08, margin: "16px 0 28px" }}>
              A tailor measures<br />before they cut.<br /><em style={{ fontStyle: "italic", color: ASH }}>So do we.</em>
            </h2>
            <p style={{ fontFamily: "Archivo, sans-serif", fontSize: 16, color: ASH, lineHeight: 1.78, maxWidth: 420, margin: "0 0 32px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            {[
              ...
              <div key={s.n} style={{ display: "flex", gap: 24, padding: "32px 0", borderBottom: i < 2 ? "1px solid rgba(16,17,20,0.09)" : "none" }}>
                <span style={{ fontFamily: "Fraunces, serif", fontSize: 42, fontWeight: 300, color: BRASS, lineHeight: 1, minWidth: 56, opacity: 0.5 }}>{s.n}</span>
                <div>
                  <div style={{ fontFamily: "Archivo, sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: OBSIDIAN, marginBottom: 8 }}>{s.label}</div>
                  <p style={{ fontFamily: "Archivo, sans-serif", fontSize: 14, color: ASH, lineHeight: 1.72, margin: 0 }}>{s.desc}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div style={{ position: "absolute", top: "50%", left: 80, transform: "translateY(-50%)" }}>
            <FitMark size={22} padded={false}>
              <div style={{ padding: "20px 28px" }}>
                <p style={{ fontFamily: "Fraunces, serif", fontSize: 30, fontStyle: "italic", color: BONE, margin: 0, lineHeight: 1.3, maxWidth: 420 }}>"Food is the vehicle.<br />Performance is the destination."</p>
      ...
      <section style={{ background: BONE, padding: "128px 32px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 56 }}>
            <div>
              <span style={{ fontFamily: "Archivo, sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: BRASS }}>What you receive</span>
              <h2 style={{ fontFamily: "Fraunces, serif", fontSize: 48, fontWeight: 400, color: OBSIDIAN, letterSpacing: "-0.025em", margin: "12px 0 0", lineHeight: 1.05 }}>Three parts.<br />One fit.</h2>
            </div>
            ...
            {[
              ...
              >
                ...
                <div style={{ position: "absolute", bottom: 32, left: 32, right: 32 }}>
                  <span style={{ fontFamily: "Archivo, sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: BRASS }}>{card.tag}</span>
                  <h3 style={{ fontFamily: "Fraunces, serif", fontSize: 28, fontWeight: 400, color: BONE, margin: "8px 0 12px", lineHeight: 1 }}>{card.label}</h3>
                  <p style={{ fontFamily: "Archivo, sans-serif", fontSize: 13, color: "rgba(245,242,235,0.6)", lineHeight: 1.6, margin: 0 }}>{card.desc}</p>
                </div>
      ...
      <section style={{ background: OBSIDIAN, padding: "128px 32px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 56 }}>
            <div>
              <span style={{ fontFamily: "Archivo, sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: BRASS }}>Stories</span>
              <h2 style={{ fontFamily: "Fraunces, serif", fontSize: 48, fontWeight: 400, color: BONE, letterSpacing: "-0.025em", margin: "12px 0 0", lineHeight: 1.05 }}>Built for real people.<br /><em style={{ fontStyle: "italic", color: "rgba(245,242,235,0.4)" }}>Results vary.</em></h2>
            </div>
            <button onClick={() => go("/stories")} style={{ background: "none", border: "1px solid rgba(245,242,235,0.2)", color: "rgba(245,242,235,0.6)", cursor: "pointer", fontFamily: "Archivo, sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", padding: "12px 22px", borderRadius: 4, transition: "all 0.15s" }} onMouseEnter={e => { e.currentTarget.style.color = BONE; e.currentTarget.style.borderColor = "rgba(245,242,235,0.45)"; }} onMouseLeave={e => { e.currentTarget.style.color = "rgba(245,242,235,0.6)"; e.currentTarget.style.borderColor = "rgba(245,242,235,0.2)"; }}>All stories</button>
          </div>
              ...
              <div key={s.name} style={{ background: "#161A1F", padding: "52px" }}>
                <FitMark size={18} padded={false}>
                  <div style={{ padding: "8px 12px" }}>
                    <p style={{ fontFamily: "Fraunces, serif", fontSize: 22, fontStyle: "italic", color: BONE, lineHeight: 1.55, margin: 0 }}>"{s.quote}"</p>
                  </div>
                </FitMark>
                <div style={{ marginTop: 32, paddingTop: 20, borderTop: "1px solid rgba(183,146,86,0.18)" }}>
                  <span style={{ fontFamily: "Archivo, sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: BRASS }}>{s.name}</span>
                  <p style={{ fontFamily: "Archivo, sans-serif", fontSize: 11, color: "rgba(245,242,235,0.32)", margin: "4px 0 0" }}>{s.title} — SAMPLE — replace with real customer</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section style={{ background: EMBER, padding: "112px 32px" }}>
        <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
          <FitMark size={28} className="block" padded>
            <h2 style={{ fontFamily: "Fraunces, serif", fontSize: "clamp(36px, 4.5vw, 60px)", fontWeight: 400, color: BONE, letterSpacing: "-0.025em", margin: "0 0 18px", lineHeight: 1.05 }}>Your fit starts here.</h2>
            <p style={{ fontFamily: "Archivo, sans-serif", fontSize: 16, color: "rgba(245,242,235,0.8)", lineHeight: 1.72, margin: "0 0 36px" }}>Ten minutes. Your body, your goals, your preferences — the plan calibrates itself around you.</p>
            <button onClick={() => go("/plan")} style={{ background: BONE, color: OBSIDIAN, border: "none", cursor: "pointer", fontFamily: "Archivo, sans-serif", fontSize: 12, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", padding: "18px 40px", borderRadius: 4, display: "inline-flex", alignItems: "center", gap: 8, transition: "background 0.15s, color 0.15s" }} onMouseEnter={e => { e.currentTarget.style.background = OBSIDIAN; e.currentTarget.style.color = BONE; }} onMouseLeave={e => { e.currentTarget.style.background = BONE; e.currentTarget.style.color = OBSIDIAN; }}>
